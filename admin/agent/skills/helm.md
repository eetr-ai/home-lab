...
whoever holds `admin:deploy` can install anything the cluster can reach. A chart's
templates are arbitrary manifests. That makes an unattended deploy a larger thing
