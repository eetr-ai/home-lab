...
export function CreateNamespacePanel({
	...
	return (
		<CreatePanel
			...
			title="New namespace"
			icon={Layers}
			description="Names follow Kubernetes' DNS label rules: lowercase letters, digits, and hyphens. Where this panel deploys with Helm, a new namespace is set up for it straight away, so you can deploy into it without reinstalling anything."
